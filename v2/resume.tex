...
\begin{resumecols}{Agile Oasis Technologies}{http://agileoasis.com}{Web Developer Intern}{Summer 2015, 2013}
    Developed the social network Project Qi (\href{http://www.projectqi.com}{\texttt{projectqi.com}}) aiming to connect users to non-profits. I built standard social media features such as a profile, feed, pictures, and groups and worked closely with the client to craft the experience he had in mind.
    \lb
...
\begin{resumecols1}{Programming}
    Java, Python, C/C++: solid foundation in the style and uses of these languages \\
    Web development: experience with PHP, SQL, JavaScript, and HTML/CSS \\
    Linux: daily usage of top-level components (CLI, scripting, Git)
\end{resumecols1}
