...
\geometry{letterpaper, portrait, margin=.80in}
...
\begin{resumecols}{Thumbtack}{https://www.thumbtack.com/about}{Senior Software Engineer}{June 2018 - Present}
    Worked on the Customer Growth and Mobile Infrastructure teams as an Android engineer. I built features and ran A/B tests throughout the product on both the native Android apps and backend in PHP/Go/Python. As part of the small Mobile Infrastructure team I managed app architecture, code quality, build/release pipelines, and developer productivity for the entire Android team. The apps were built primarily in Kotlin with heavy usage of the reactive paradigm via RxJava.
\end{resumecols}
...
\begin{resumecols1}{Programming}
    Java/Kotlin, Python, Go, C/C++: solid foundation in the style and uses of these languages \\
